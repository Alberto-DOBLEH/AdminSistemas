...
function crear_user_ad{
    ...
    try{
        New-ADUser -Name $user -SamAccountName $user -AccountPassword $password -Enabled $true -Path $ouPath -PasswordNeverExpires $true -PassThru | Set-ADUser -ChangePasswordAtLogon $false
